...
/* 050278 800506C8 3C040100 */  lui         $a0, (0x1000800 >> 16)
/* 05027C 800506CC 0C015D50 */  jal         __osSetFpcCsr
/* 050280 800506D0 34840800 */   ori        $a0, $a0, (0x1000800 & 0xFFFF)
/* 050284 800506D4 0C015D54 */  jal         __osGetWatchLo
/* 050288 800506D8 3C040490 */   lui        $a0, 0x490
/* 05028C 800506DC 3C041FC0 */  lui         $a0, (0x1FC007FC >> 16)
/* 050290 800506E0 348407FC */  ori         $a0, $a0, (0x1FC007FC & 0xFFFF)
/* 050294 800506E4 0C015D58 */  jal         __osSiRawReadIo
/* 050298 800506E8 27A5002C */   addiu      $a1, $sp, 0x2c
/* 05029C 800506EC 10400007 */  beqz        $v0, .L8005070C
/* 0502A0 800506F0 00000000 */   nop
.L800506F4:
/* 0502A4 800506F4 3C041FC0 */  lui         $a0, (0x1FC007FC >> 16)
/* 0502A8 800506F8 348407FC */  ori         $a0, $a0, (0x1FC007FC & 0xFFFF)
/* 0502AC 800506FC 0C015D58 */  jal         __osSiRawReadIo
/* 0502B0 80050700 27A5002C */   addiu      $a1, $sp, 0x2c
/* 0502B4 80050704 1440FFFB */  bnez        $v0, .L800506F4
/* 0502B8 80050708 00000000 */   nop
.L8005070C:
/* 0502BC 8005070C 8FA5002C */  lw          $a1, 0x2c($sp)
/* 0502C0 80050710 3C041FC0 */  lui         $a0, (0x1FC007FC >> 16)
/* 0502C4 80050714 348407FC */  ori         $a0, $a0, (0x1FC007FC & 0xFFFF)
/* 0502C8 80050718 34AF0008 */  ori         $t7, $a1, 0x8
/* 0502CC 8005071C 0C015D6C */  jal         __osSiRawWriteIo
/* 0502D0 80050720 01E02825 */   move       $a1, $t7
/* 0502D4 80050724 10400009 */  beqz        $v0, .L8005074C
/* 0502D8 80050728 00000000 */   nop
.L8005072C:
/* 0502DC 8005072C 8FA5002C */  lw          $a1, 0x2c($sp)
/* 0502E0 80050730 3C041FC0 */  lui         $a0, (0x1FC007FC >> 16)
/* 0502E4 80050734 348407FC */  ori         $a0, $a0, (0x1FC007FC & 0xFFFF)
/* 0502E8 80050738 34B80008 */  ori         $t8, $a1, 0x8
/* 0502EC 8005073C 0C015D6C */  jal         __osSiRawWriteIo
/* 0502F0 80050740 03002825 */   move       $a1, $t8
/* 0502F4 80050744 1440FFF9 */  bnez        $v0, .L8005072C
/* 0502F8 80050748 00000000 */   nop
.L8005074C:
/* 0502FC 8005074C 3C088005 */  lui         $t0, %hi(__osExceptionPreamble)
/* 050300 80050750 25087600 */  addiu       $t0, $t0, %lo(__osExceptionPreamble)
/* 050304 80050754 8D010000 */  lw          $at, 0x0($t0)
/* 050308 80050758 3C198000 */  lui         $t9, %hi(D_80000000)
/* 05030C 8005075C 3C0D8005 */  lui         $t5, %hi(__osExceptionPreamble)
/* 050310 80050760 AF210000 */  sw          $at, %lo(D_80000000)($t9)
/* 050314 80050764 8D0B0004 */  lw          $t3, 0x4($t0)
/* 050318 80050768 25AD7600 */  addiu       $t5, $t5, %lo(__osExceptionPreamble)
/* 05031C 8005076C 3C0C8000 */  lui         $t4, (0x80000080 >> 16)
/* 050320 80050770 AF2B0004 */  sw          $t3, %lo(D_80000004)($t9)
/* 050324 80050774 8D010008 */  lw          $at, 0x8($t0)
/* 050328 80050778 358C0080 */  ori         $t4, $t4, (0x80000080 & 0xFFFF)
/* 05032C 8005077C 3C098005 */  lui         $t1, %hi(__osExceptionPreamble)
/* 050330 80050780 AF210008 */  sw          $at, %lo(D_80000008)($t9)
/* 050334 80050784 8D0B000C */  lw          $t3, 0xc($t0)
/* 050338 80050788 25297600 */  addiu       $t1, $t1, %lo(__osExceptionPreamble)
/* 05033C 8005078C 3C0A8000 */  lui         $t2, (0x80000100 >> 16)
/* 050340 80050790 AF2B000C */  sw          $t3, %lo(D_8000000C)($t9)
/* 050344 80050794 8DA10000 */  lw          $at, 0x0($t5)
/* 050348 80050798 354A0100 */  ori         $t2, $t2, (0x80000100 & 0xFFFF)
/* 05034C 8005079C 3C0E8005 */  lui         $t6, %hi(__osExceptionPreamble)
/* 050350 800507A0 AD810000 */  sw          $at, 0x0($t4)
/* 050354 800507A4 8DB80004 */  lw          $t8, 0x4($t5)
/* 050358 800507A8 25CE7600 */  addiu       $t6, $t6, %lo(__osExceptionPreamble)
/* 05035C 800507AC 3C0F8000 */  lui         $t7, (0x80000180 >> 16)
/* 050360 800507B0 AD980004 */  sw          $t8, 0x4($t4)
/* 050364 800507B4 8DA10008 */  lw          $at, 0x8($t5)
/* 050368 800507B8 35EF0180 */  ori         $t7, $t7, (0x80000180 & 0xFFFF)
...
/* 0503D8 80050828 0C015FCC */  jal         osUnmapTLBAll
...
/* 0503FC 8005084C 0C01492E */  jal         __ll_mul
...
/* 050418 80050868 0C0148EE */  jal         __ull_div
/* 05041C 8005086C 24070004 */   addiu      $a3, $zero, 0x4
/* 050420 80050870 3C088000 */  lui         $t0, %hi(osResetType)
/* 050424 80050874 8D08030C */  lw          $t0, %lo(osResetType)($t0)
/* 050428 80050878 3C01800A */  lui         $at, %hi(D_8009DC70)
/* 05042C 8005087C AC22DC70 */  sw          $v0, %lo(D_8009DC70)($at)
/* 050430 80050880 15000005 */  bnez        $t0, .L80050898
/* 050434 80050884 AC23DC74 */   sw         $v1, %lo(D_8009DC74)($at)
/* 050438 80050888 3C048000 */  lui         $a0, %hi(osAppNmiBuffer)
/* 05043C 8005088C 2484031C */  addiu       $a0, $a0, %lo(osAppNmiBuffer)
/* 050440 80050890 0C014388 */  jal         bzero
/* 050444 80050894 24050040 */   addiu      $a1, $zero, 0x40
.L80050898:
/* 050448 80050898 3C198000 */  lui         $t9, %hi(osTvType)
/* 05044C 8005089C 8F390300 */  lw          $t9, %lo(osTvType)($t9)
/* 050450 800508A0 17200006 */  bnez        $t9, .L800508BC
/* 050454 800508A4 00000000 */   nop
/* 050458 800508A8 3C0A02F5 */  lui         $t2, (0x2F5B2D2 >> 16)
/* 05045C 800508AC 354AB2D2 */  ori         $t2, $t2, (0x2F5B2D2 & 0xFFFF)
...
.L800508BC:
/* 05046C 800508BC 3C098000 */  lui         $t1, %hi(osTvType)
/* 050470 800508C0 8D290300 */  lw          $t1, %lo(osTvType)($t1)
/* 050474 800508C4 24010002 */  addiu       $at, $zero, 0x2
/* 050478 800508C8 15210006 */  bne         $t1, $at, .L800508E4
/* 05047C 800508CC 00000000 */   nop
/* 050480 800508D0 3C0B02E6 */  lui         $t3, (0x2E6025C >> 16)
/* 050484 800508D4 356B025C */  ori         $t3, $t3, (0x2E6025C & 0xFFFF)
...
.L800508E4:
/* 050494 800508E4 3C0D02E6 */  lui         $t5, (0x2E6D354 >> 16)
/* 050498 800508E8 35ADD354 */  ori         $t5, $t5, (0x2E6D354 & 0xFFFF)
...
/* 0504B0 80050900 11800003 */  beqz        $t4, .L80050910
...
/* 050550 800509A0 444FF800 */  cfc1        $t7, FpcCsr
/* 050554 800509A4 44C3F800 */  ctc1        $v1, FpcCsr
/* 050558 800509A8 00000000 */  nop
/* 05055C 800509AC 46000224 */  cvt.w.s     $f8, $f0
/* 050560 800509B0 4443F800 */  cfc1        $v1, FpcCsr
...
.L80050A18:
/* 0505C8 80050A18 44CFF800 */  ctc1        $t7, FpcCsr
/* 0505CC 80050A1C 2C610084 */  sltiu       $at, $v1, 0x84
/* 0505D0 80050A20 10200003 */  beqz        $at, .L80050A30
...
/* 0505F4 80050A44 14200002 */  bnez        $at, .L80050A50
...
/* 050618 80050A68 14600002 */  bnez        $v1, .L80050A74
