...
/* 05D134 8005D584 0C015FFC */  jal         __osDisableInt
...
/* 05D174 8005D5C4 0C016020 */  jal         __osDequeueThread
/* 05D178 8005D5C8 03002825 */   move       $a1, $t8
.L8005D5CC:
/* 05D17C 8005D5CC 3C08800A */  lui         $t0, %hi(__osActiveQueue)
/* 05D180 8005D5D0 8D08F89C */  lw          $t0, %lo(__osActiveQueue)($t0)
...
/* 05D194 8005D5E4 3C01800A */  lui         $at, %hi(__osActiveQueue)
/* 05D198 8005D5E8 10000013 */  b           .L8005D638
/* 05D19C 8005D5EC AC2AF89C */   sw         $t2, %lo(__osActiveQueue)($at)
.L8005D5F0:
/* 05D1A0 8005D5F0 3C11800A */  lui         $s1, %hi(__osActiveQueue)
/* 05D1A4 8005D5F4 8E31F89C */  lw          $s1, %lo(__osActiveQueue)($s1)
...
.L8005D638:
/* 05D1E8 8005D638 3C19800A */  lui         $t9, %hi(__osRunningThread)
/* 05D1EC 8005D63C 8F39F8A0 */  lw          $t9, %lo(__osRunningThread)($t9)
/* 05D1F0 8005D640 8FAF0038 */  lw          $t7, 0x38($sp)
/* 05D1F4 8005D644 15F90003 */  bne         $t7, $t9, .L8005D654
/* 05D1F8 8005D648 00000000 */   nop
/* 05D1FC 8005D64C 0C015F69 */  jal         __osDispatchThread
/* 05D200 8005D650 00000000 */   nop
.L8005D654:
/* 05D204 8005D654 0C016018 */  jal         __osRestoreInt
