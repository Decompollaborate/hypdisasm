...
/* 054330 80054780 1020000F */  beq         $at, $zero, .L800547C0
...
/* 054344 80054794 10200008 */  beq         $at, $zero, .L800547B8
...
.L800547A8:
/* 054358 800547A8 BD190000 */  (0x2f)      $t9, 0x0($t0)
/* 05435C 800547AC 0109082B */  sltu        $at, $t0, $t1
/* 054360 800547B0 1420FFFD */  bne         $at, $zero, .L800547A8
/* 054364 800547B4 25080010 */   addiu      $t0, $t0, 0x10
.L800547B8:
/* 054368 800547B8 03E00008 */  jr          $ra
/* 05436C 800547BC 00000000 */   nop
.L800547C0:
/* 054370 800547C0 3C088000 */  lui         $t0, %hi(D_80000010)
/* 054374 800547C4 010B4821 */  addu        $t1, $t0, $t3
/* 054378 800547C8 2529FFF0 */  addiu       $t1, $t1, -0x10
.L800547CC:
/* 05437C 800547CC BD010000 */  (0x2f)      $at, %lo(D_80000000)($t0)
/* 054380 800547D0 0109082B */  sltu        $at, $t0, $t1
/* 054384 800547D4 1420FFFD */  bne         $at, $zero, .L800547CC
/* 054388 800547D8 25080010 */   addiu      $t0, $t0, %lo(D_80000010)
